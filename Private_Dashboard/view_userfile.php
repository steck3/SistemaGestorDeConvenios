          ...
          <!--   <li class="nav-item active">
            ...
            <?php 
             ...
             require_once("include/connection.php");
              ...
              $r = mysqli_query($conn,"SELECT * FROM usuarios where id = '$id'") or die (mysqli_error($con));
...
<tbody>
    ...
    <tr>
      ...
      $query = mysqli_query($conn,"SELECT DISTINCT ID,NAME,SIZE,EMAIL,tipo_usuario,TIMERS,DOWNLOAD FROM upload_files WHERE tipo_usuario = 'Employee' group by NAME DESC") or die (mysqli_error($con));
      while($file=mysqli_fetch_array($query)){
         $id =  $file['ID'];
         $name =  $file['NAME'];
         $size =  $file['SIZE'];
          $email =  $file['EMAIL'];
         $uploads =  $file['tipo_usuario'];
         $time =  $file['TIMERS'];
