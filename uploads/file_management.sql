...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-05-2023 a las 04:15:17
...
INSERT INTO `convenio` (`id_conv`, `nombre`, `organismo`, `status`, `vigencia_inicio`, `vigencia_final`, `rep_ext`, `op_ext`, `dept_ext`, `firma_ext`, `rep_int`, `op_int`, `dep_int`, `firma_int`, `beneficios`, `compromisos`, `id_archivo`, `estatus`) VALUES
(3, 'convenio prueba55', 'Universidad del caribe', 0, '2003-03-08', '2005-03-01', '', '', '', '2000-05-01', '', '', '', '2003-03-01', 'opopopopop', 'k.mklmlkm', 0, 0),
(4, 'convenio prueba56', 'Hogwards', 0, '2003-03-01', '2005-03-01', '', '', '', '2000-05-01', '', '', '', '2003-03-05', 'cacsaa', 'adasda', 0, 0),
(5, 'convenio prueba78', 'UPSI', 0, '2003-03-08', '2005-03-01', 'Rectora Pricila Sosa', 'Ana', 'psofa', '0000-00-00', 'psofa', '', 'Alberto', '2003-03-05', 'fdbcfb', 'vdfbxb', 0, 0),
(6, 'Pr45', 'cambridge', 0, '2003-03-07', '2005-03-01', 'Rector. DR.EFRAÍN', 'Andres', 'Salud Publica', '2002-05-10', 'Salud Publica', '', 'Carlos', '2003-03-08', 'nkhnhk', 'jkkhkh', 0, 0),
(7, 'TP645', 'ULSA', 0, '2003-03-07', '2005-03-01', 'lorem impsua', 'Alberto', 'dsfsd', '2000-05-01', 'Salud Publica', '', 'Tayron', '2003-03-01', 'zfzsfa', 'adada', 0, 0),
...
(13, 'Convenio De la Universidad de Granada', 'Universidad de Granada', 0, '2003-03-01', '2005-03-01', 'Dr Carlos', 'Luna', 'Practicas', '2000-05-01', 'Rectora Pricila Sosa', 'Mario', 'Administracion', '2003-03-01', '   ---', '---', 0, 0),
(14, 'convenio prueba 14', 'ut', 0, '2003-03-01', '2005-03-01', 'Sr Juan', 'Ana', 'Negocios', '2002-05-10', 'Rector. DR.EFRAÍN', 'Andres', 'Danza', '2003-03-08', 'popooopopopop', 'fafafaaffa', 0, 0),
(15, 'convenio 15', 'Hogwards', 0, '2003-03-07', '2005-03-01', 'Lorem Impsu', 'Carlos', 'Biblioteca', '2000-05-01', 'Sr Juan', 'Pedro', 'dsfsd', '2003-03-01', 'llplp', 'nknknkn k', 0, 0);
...
(11, 'Negocios', 'Carla', 'Universidad de Granada');
...
(0, 0, 'donjoea@test', 'Inicio sesión', 'Has LoggedOut the system at', '::1', 'LAPTOP-874GVJN5', 'Apr-19-2023 11:20 AM', 'Apr-20-2023 05:50 AM'),
(0, 0, 'donjoea@test', 'Inicio sesión', 'Has LoggedOut the system at', '::1', 'LAPTOP-874GVJN5', 'Apr-19-2023 11:21 AM', 'Apr-20-2023 05:50 AM'),
(0, 0, 'donjoea@test', 'Inicio sesión', 'Has LoggedOut the system at', '::1', 'LAPTOP-874GVJN5', 'Apr-19-2023 11:21 AM', 'Apr-20-2023 05:50 AM'),
(0, 0, 'donjoea@test', 'Inicio sesión', 'Has LoggedOut the system at', '::1', 'LAPTOP-874GVJN5', 'Apr-19-2023 11:21 AM', 'Apr-20-2023 05:50 AM'),
(0, 0, 'admin@admin', 'Inicio sesión', 'Has LoggedOut the system at', '::1', 'LAPTOP-874GVJN5', 'Apr-19-2023 11:22 AM', 'Apr-20-2023 05:50 AM'),
(0, 0, 'donjoea@test', 'Inicio sesión', 'Has LoggedOut the system at', '::1', 'LAPTOP-874GVJN5', 'Apr-19-2023 11:22 AM', 'Apr-20-2023 05:50 AM'),
(0, 0, 'donjoea@test', 'Inicio sesión', 'Has LoggedOut the system at', '::1', 'LAPTOP-874GVJN5', 'Apr-19-2023 11:23 AM', 'Apr-20-2023 05:50 AM'),
(0, 0, 'donjoea@test', 'Inicio sesión', 'Has LoggedOut the system at', '::1', 'LAPTOP-874GVJN5', 'Apr-19-2023 11:24 AM', 'Apr-20-2023 05:50 AM'),
(0, 0, 'admin@admin', 'Inicio sesión', 'Has LoggedOut the system at', '::1', 'LAPTOP-874GVJN5', 'Apr-19-2023 11:24 AM', 'Apr-20-2023 05:50 AM'),
...
INSERT INTO `organismos` (`id_orga`, `nombre`, `id_org`, `tipo`, `representante`, `operador`, `direccion`, `codigo postal`) VALUES
(1, 'test2', 'camb20', 'institucion academica', 'lorem impsu', 'Mario', '', 0),
(3, 'Universidad del caribe', 'caribe02', 'institucion academica', 'Rectora Pricila Sosa', 'Rodrigo', 'dsvzd', 77500),
(5, 'Hogwards', 'Hg12', 'Ficticio', 'Snap', 'Luna', '-....-', 77500),
(6, 'ULSA', 'ULSA1', 'institucion academica', 'Ulises', 'Andres', 'ULSA-775', 775355),
(7, 'UPSI', 'UPSI', 'institucion academica', 'Pablo', 'Tayron', 'Fidu-56', 556622),
(8, 'Universidad del Sur', 'USUR23', 'Institución academica', 'Rector. DR.EFRAÍN', 'Ana', 'cancun qroo', 77500),
(9, 'ut', 'UT02', 'institucion academica', 'Dr Francisco', 'Carlos', 'Sm 20', 3320),
(10, 'UMAYA', 'UMA', 'institucion academica', 'Sr Juan', 'Pepe', 'Sm 20', 75000),
(11, 'Universidad de Granada', 'Gr2', 'Institucion academica', 'Dr Carlos', 'Mario', 'Sm 20', 77500);
...
INSERT INTO `upload_files` (`id_archivo`, `usuario`, `SIZE`, `DOWNLOAD`, `TIMERS`, `tipo_usuario`, `EMAIL`, `firma_int`) VALUES
(3, 0, '187621', '0', 'Feb-16-2023 10:12 AM', 'Admin', 'Enriq', NULL),
(4, 0, '902182', '0', 'Feb-18-2023 11:59 AM', 'Admin', 'Enriq', NULL);
...
(20, 'doe joe', 'doejoe@caribe', '$2y$12$f35vm8Yyu1/ldHJ3EKgRj.TEuyouTEHt0GmtxqnX6iJsFcbQgUMMG', 'Administrador'),
(21, 'test1', 'test1@caribe', '$2y$12$2HGD9g3wQ7roKD75bKdNEOfAgcXmRj190WViW1KMDOiYrvX3hxpMi', 'usuario'),
(24, 'DonOp', 'oper@caribe', '$2y$12$iJ3Ez8Tgl4wAe.57WVTPYOHZUSwhxs9SV0NQZp6VMpSoP0V4y/CwO', 'operador'),
(25, 'test155', 'test1@caribes', '$2y$12$fBYSH.NN4dMzwgQkmfpatue7a955TR1h184AT4b1jnww5g/9jBpli', 'admin'),
(27, 'admin', 'admin@caribe', '$2y$12$f3iMaj7vHdeCocmSwPVz/.tVVSXmDEcNThUhgJR1HspjECvaodJWG', 'Administrador'),
(29, 'Enrique', 'admin@admin', '$2y$12$wu1O0c6kL9RLOB2Cqg3MuOxfJ4LKnDIVKZhCfcSRaut6LzGQNJgMq', 'admin'),
(30, 'DonOp', 'oper@caribe', '$2y$12$fH4e19ftjC5pO0b3IRjOkOL1kyUmvGLRgB.qMD3qIm.h97d34031u', 'admin'),
...
ALTER TABLE `convenio`
  ...
  ADD KEY `conexiones` (`id_archivo`,`estatus`) USING BTREE;
...
--
ALTER TABLE `convenio`
  MODIFY `id_conv` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
